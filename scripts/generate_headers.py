...
def generate_header(m, n, output_dir, filename_override=None):
    ...
    # Check for overflow of ONE (e.g. Q0.7 where 1.0 is not representable)
    # storage_max is a string "INT8_MAX", we need the value.
    limit_vals = {
        "int8_t": 127,
        "int16_t": 32767,
        "int32_t": 2147483647,
    ...
    limit = limit_vals.get(storage_type, 0)
